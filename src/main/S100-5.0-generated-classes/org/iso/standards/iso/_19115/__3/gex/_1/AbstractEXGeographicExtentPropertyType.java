...
/**
 * <p>Java class for AbstractEX_GeographicExtent_PropertyType complex type.
 * 
 ...
 *         &lt;element ref="{http://standards.iso.org/iso/19115/-3/gex/1.0}AbstractEX_GeographicExtent"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "AbstractEX_GeographicExtent_PropertyType", propOrder = {
    "abstractEXGeographicExtent"
})
public class AbstractEXGeographicExtentPropertyType {

    @XmlElementRef(name = "AbstractEX_GeographicExtent", namespace = "http://standards.iso.org/iso/19115/-3/gex/1.0", type = JAXBElement.class, required = false)
