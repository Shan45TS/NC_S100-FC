...
public enum CurveInterpolationType {
    ...
    /**
     * Note that the new draft of 19107 now includes "rhumb".
     * 
     */
    @XmlEnumValue("loxodromic")
