 ...
 * generated in the _int.iho.s100ci._5 package. 
...
public class ObjectFactory {
    ...
    private final static QName _CIResponsibility_QNAME = new QName("http://www.iho.int/S100CI/5.0", "CI_Responsibility");
    private final static QName _AbstractCIParty_QNAME = new QName("http://www.iho.int/S100CI/5.0", "AbstractCI_Party");
    private final static QName _CIIndividual_QNAME = new QName("http://www.iho.int/S100CI/5.0", "CI_Individual");
    private final static QName _CIOrganisation_QNAME = new QName("http://www.iho.int/S100CI/5.0", "CI_Organisation");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: _int.iho.s100ci._5
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://www.iho.int/S100CI/5.0", name = "CI_Responsibility")
     ...
     */
    @XmlElementDecl(namespace = "http://www.iho.int/S100CI/5.0", name = "AbstractCI_Party")
     ...
     */
    @XmlElementDecl(namespace = "http://www.iho.int/S100CI/5.0", name = "CI_Individual", substitutionHeadNamespace = "http://www.iho.int/S100CI/5.0", substitutionHeadName = "AbstractCI_Party")
     ...
     */
    @XmlElementDecl(namespace = "http://www.iho.int/S100CI/5.0", name = "CI_Organisation", substitutionHeadNamespace = "http://www.iho.int/S100CI/5.0", substitutionHeadName = "AbstractCI_Party")
