 ...
 *       &lt;sequence&gt;
 *         &lt;element name="message" type="{http://www.iho.int/S100AlertCatalog/5.2}MessageItem" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Messages {
    ...
    protected List<MessageItem> message;
    ...
    public List<MessageItem> getMessage() {
        if (message == null) {
            message = new ArrayList<MessageItem>();
        }
        return this.message;
    }
